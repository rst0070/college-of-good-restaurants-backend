insert into review(review_id, PLACE_id, USER_id, post_date, post_text, rating) values(16610622302321234,1, 'wonbinkim', '2022-05-31', '테스트용 리뷰', 4);
    insert into REVIEW_IMAGE_LIST(image_id, REVIEW_id, image_url) values (16610622302320982, 16610622302321234, 'https://test.image.1');
    insert into REVIEW_IMAGE_LIST(image_id, REVIEW_id, image_url) values (16610622302321243, 16610622302321234, 'https://test.image.2');
    insert into REVIEW_IMAGE_LIST(image_id, REVIEW_id, image_url) values (16610622302321324, 16610622302321234, 'https://test.image.3');
...
insert into REVIEW_IMAGE_LIST(image_id, REVIEW_id, image_url) values (16610622302326734, 16618655171448795, '	https://mblogthumb-phinf.pstatic.net/MjAxOTA4MjdfMTQ3/MDAxNTY2OTEwNzcxODYz.zY4lJ7sbxCkOa8mE4ZSVRUpUbD4a6U-wTjkIX603fYcg.qDdV01hHy8EU1nZvaG_WPR4lHd_XIQurZvA0jm7pDVkg.JPEG.ynk_1204/1566909783835.jpg?type=w800');
insert into REVIEW_IMAGE_LIST(image_id, REVIEW_id, image_url) values (16610622302327634, 16618655171448795, 'https://mblogthumb-phinf.pstatic.net/MjAxOTA4MDJfMTQg/MDAxNTY0NzM0MDk1NjM3.NbQrTpzyrSLYj-8NxZsVK8concii0ShYe491wLv_Bjkg.BAkLQ1PmkSXscwGfzK2UIl2nEZf7yCmxOwsVR841twkg.JPEG.ynk_1204/2019-08-02-16-50-34.jpg?type=w800');
